...
-   **Selling and purchasing of servers**

    Selling servers for any monetary value, goods, servives, or other gain.
    _This excludes servers sold as part of a larger sale, such as the purchase of a brand, company, or game where the server is operated by the brand/company/game being sold. We may also approve sales on an individual basis._
