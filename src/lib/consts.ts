export default class Consts {
    ...
    static readonly WINDOWS_BUILD_URL =
        "https://github.com/stoatchat/for-desktop/releases/download/v1.1.11/stoat-desktop-setup.exe" as const;
    static readonly MACOS_ARM64_BUILD_URL =
        "https://github.com/stoatchat/for-desktop/releases/download/v1.1.11/Stoat-darwin-arm64-1.1.11.zip" as const;
    static readonly MACOS_X64_BUILD_URL =
        "https://github.com/stoatchat/for-desktop/releases/download/v1.1.11/Stoat-darwin-x64-1.1.11.zip" as const;
    static readonly LINUX_UNPACKED_ARM64_BUILD_URL =
        "https://github.com/stoatchat/for-desktop/releases/download/v1.1.11/Stoat-linux-arm64-1.1.11.zip" as const;
    static readonly LINUX_UNPACKED_X64_BUILD_URL =
        "https://github.com/stoatchat/for-desktop/releases/download/v1.1.11/Stoat-linux-x64-1.1.11.zip" as const;
}
